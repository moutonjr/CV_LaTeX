...
\usepackage{calc}
\usepackage[colorlinks=false,%,linkcolor=black,urlcolor=black,citecolor=black,
...
%\newcommand{\alinea}[1]{{\scriptsize \it \begin{itemize}\setlength\itemsep{.5em}#1\vspace{-1.2em}\end{itemize}}}
...
\end{center}
	...
	{ % EXPERIENCE
		...
		\begin{rubrique}{Expérience}
			...
			\alinea{
				...
				%\item \emph{Large connaissance du marché} technique, d'Unix, en intégration de systèmes, en \emph{structures architecturales, de virtualisation et de sécurité appliquée} ;
				%\item Mise en place d'outil de déploiement automatique d'infrastructure chez Thales : \emph{1-infra-en-1-heure} ;
            ...
            % Oct 2011			& \href{http://www.gala.supelec.fr}{{\large Gala Supélec}} : Trésorier des préventes : 5600 personnes, 300 000\officialeuro \\
			%Aou~2011				& {\large \href{http://www.voyages-sncf.fr}{SNCF}}, Tours : Gestion des retards des trains et accueil, information des voyageurs.   \href{http://www.voyages-sncf.fr}{\includegraphics[height=\imgsize]{Resource/SNCF.png}}\\
		\end{rubrique}
	}
	{ % FORMATION
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	{ % DIVERS
		...
		\begin{myitemize}
		\vspace{-1em}
			\item Littérature et langue française (8\ieme\ sur 260 à la \href{http://dictee.ece.fr/}{dictée ECE}),\\
